...
class CompanyInfoViewController: UIViewController, UITextFieldDelegate{
    ...
    var fundData = ["Just exploring, have not begun to raise capital", //NONE OF THESE FIT
                "Currently seeking to raise capital for the first time",
                "Already raised capital, seeking to raise additional capital"]
